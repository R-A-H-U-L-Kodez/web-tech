                            ...
                            <div className="lg:col-span-2">
                                <div className="flex flex-col items-start">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <a href="https://x.com/i_intern_agency" target="_blank" rel="noopener noreferrer" aria-label="Follow us on X" className="group flex h-9 w-9 items-center justify-center rounded-lg bg-slate-200 dark:bg-white/5 text-slate-500 dark:text-zinc-300 ring-1 ring-slate-300 dark:ring-white/10 transition hover:bg-slate-300 dark:hover:bg-white/10">
