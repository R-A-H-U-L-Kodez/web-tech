...
import LogoLoop, { ReactNodeLogo } from '@/components/ui/LogoLoop';
                ...
                <div className="pt-24 pb-20 sm:pt-32 sm:pb-28 lg:pt-40 lg:pb-32 max-w-7xl mr-auto ml-auto relative">
                    ...
                    <div className="text-center relative z-10">
                        ...
                        <AnimatedInView animationType="scale-in" delay={200}>
                            <div
                                className="mx-auto mt-6 sm:mt-8 max-w-3xl text-base sm:text-lg font-medium leading-relaxed text-slate-600 dark:text-slate-300 transition-colors duration-300 px-2 space-y-1"
                                style={{ textShadow: '0 1px 10px rgba(34, 211, 238, 0.15)' }}
                            >
                                <p className="text-slate-900 dark:text-white font-semibold">
                                    Elite Web Design & Development Services for Businesses
                                </p>
                                <p className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-sky-600 dark:from-cyan-400 dark:to-sky-400 font-semibold">
                                    That Refuse to Blend In
                                </p>
                                <p className="text-slate-600 dark:text-slate-300">
                                    Aesthetically stunning, blazing-fast, and built to convert with{' '}
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-sky-600 dark:from-cyan-400 dark:to-sky-400 font-semibold">
